...
export const SIDEBAR_CATEGORIES = [
  { display_name: "Saved", name: "saved_components", icon: "GradientSave", display_name_zh: "已保存的组件" },
  { display_name: "Input / Output", name: "input_output", icon: "Cable", display_name_zh: "输入/输出" },
  { display_name: "Agents", name: "agents", icon: "Bot", display_name_zh: "代理" },
  { display_name: "Models", name: "models", icon: "BrainCog", display_name_zh: "模型" },
  { display_name: "Data", name: "data", icon: "Database", display_name_zh: "数据" },
  { display_name: "Vector Stores", name: "vectorstores", icon: "Layers", display_name_zh: "向量存储" },
  { display_name: "Processing", name: "processing", icon: "ListFilter", display_name_zh: "处理" },
  { display_name: "Logic", name: "logic", icon: "ArrowRightLeft", display_name_zh: "逻辑" },
  { display_name: "Helpers", name: "helpers", icon: "Wand2", display_name_zh: "帮助" },
  { display_name: "Inputs", name: "inputs", icon: "Download", display_name_zh: "输入" },
  { display_name: "Outputs", name: "outputs", icon: "Upload", display_name_zh: "输出" },
  { display_name: "Prompts", name: "prompts", icon: "braces", display_name_zh: "提示词" },
  { display_name: "Chains", name: "chains", icon: "Link", display_name_zh: "链" },
  { display_name: "Loaders", name: "documentloaders", icon: "Paperclip", display_name_zh: "加载器" },
  { display_name: "Link Extractors", name: "link_extractors", icon: "Link2", display_name_zh: "链接提取器" },
  { display_name: "Output Parsers", name: "output_parsers", icon: "Compass", display_name_zh: "输出解析器" },
  { display_name: "Prototypes", name: "prototypes", icon: "FlaskConical", display_name_zh: "原型" },
  { display_name: "Retrievers", name: "retrievers", icon: "FileSearch", display_name_zh: "检索器" },
  { display_name: "Text Splitters", name: "textsplitters", icon: "Scissors", display_name_zh: "文本分割器" },
  { display_name: "Toolkits", name: "toolkits", icon: "Package2", display_name_zh: "工具包" },
  { display_name: "Tools", name: "tools", icon: "Hammer", display_name_zh: "工具" },
];
