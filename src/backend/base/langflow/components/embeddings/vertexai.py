...
class VertexAIEmbeddingsComponent(LCModelComponent):
    ...
    inputs = [
        ...
        MessageTextInput(name="project", display_name="项目", info="The project ID.", advanced=True),
        ...
        MessageTextInput(name="model_name", display_name="模型名称", value="textembedding-gecko", required=True),
