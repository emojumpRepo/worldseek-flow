    ...
    inputs = [
        *ComposioBaseComponent._base_inputs,
        ...
        MessageTextInput(
            ...
            display_name="请求体",
            info="请求体 content of the email. Can be plain text or HTML based on is_html flag.",
            show=False,
            required=True,
        ),
        MessageTextInput(
        ...
        BoolInput(
            ...
            info="Set to 真 if the body content is HTML formatted",
            show=False,
            value=False,
            advanced=True,
        ),
        ...
        MessageTextInput(
            ...
            display_name="请求体",
            info="请求体 content of the event. Can be plain text or HTML.",
            show=False,
            required=True,
        ),
        BoolInput(
            ...
            display_name="Is Html",
            info="Set to 真 if the body content should be interpreted as HTML.",
            show=False,
            value=False,
            advanced=True,
        ),
        ...
        BoolInput(
            ...
            info="Set to 真 to make this an online meeting and generate a Teams 网址.",
            show=False,
            value=False,
            advanced=True,
        ),
        ...
        BoolInput(
            ...
            info="过滤器 messages by read status. If set to 假, only unread messages will be returned.",
            show=False,
            value=False,
            advanced=True,
        ),
        ...
        MessageTextInput(
            ...
            display_name="主题",
            info="过滤器 messages by subject (exact match).",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
        ...
        MessageTextInput(
            ...
            info="过滤器 messages where the subject starts with the specified string.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages where the subject ends with the specified string.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages where the subject contains the specified substring.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages with a received日期时间 greater than or equal to the specified value.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages with a received日期时间 less than the specified value.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages with a received日期时间 less than or equal to the specified value.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
        ...
        BoolInput(
            ...
            info="过滤器 messages by whether they have attachments.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages where the bodyPreview contains the specified substring.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages with a sent日期时间 greater than the specified value.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            info="过滤器 messages with a sent日期时间 less than the specified value.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
            ...
            display_name="Categories",
            info="过滤器 messages by categories. Matches if the message contains any of the specified categories.",
            show=False,
            advanced=True,
        ),
        MessageTextInput(
